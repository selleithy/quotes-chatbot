...
\
const app = express();\
const PORT = process.env.PORT || 3000; // Dynamic port for Render/AWS\
const DB_PATH = path.join(__dirname, 'quotes.db'); // Or '/tmp/quotes.db' for some hosts\
\
// Middleware\
...
\
    ...
    db.get("SELECT COUNT(*) as count FROM quotes", (err, row) => \{\
        if (row.count === 0) \{\
            const initialQuotes = [\
                // Sad/Depression\
                \{ text: "Please remember that you\'92re capable, brave and loved \'96 even when it feels like you\'92re not.", author: "Unknown", feeling: "sad" \},\
                ...
                \{ text: "Just because you\'92re going through a rough patch, it doesn\'92t mean you always will be. Recovery is possible. We promise you.", author: "Unknown", feeling: "sad" \},\
                \{ text: "In case no one told you today: you are beautiful. You are loved. You are needed. You are alive for a reason. You are stronger than you think, and if you keep on fighting, then you\'92re going to get through this.", author: "Unknown", feeling: "sad" \},\
                \
                // Anxious\
                ...
                \{ text: "Trust yourself. You\'92ve survived a lot, and you\'92ll survive whatever is coming.", author: "Robert Tew", feeling: "anxious" \},\
                ...
                \
                // Stressed\
                \{ text: "The time to relax is when you don\'92t have time for it.", author: "Sydney J. Harris", feeling: "stressed" \},\
                \{ text: "One of the best pieces of advice I ever got was from a horse master. He told me to go slow to go fast. I think that applies to everything in life. We live as though there aren\'92t enough hours in the day, but if we do each thing calmly and carefully, we will get it done quicker and with much less stress.", author: "Viggo Mortensen", feeling: "stressed" \},\
                \{ text: "Much of the stress that people feel doesn\'92t come from having too much to do. It comes from not finishing what they\'92ve started.", author: "David Allen", feeling: "stressed" \},\
                \{ text: "In times of great stress or adversity, it\'92s always best to keep busy, to plow your anger and your energy into something positive.", author: "Lee Iacocca", feeling: "stressed" \},\
                ...
                \{ text: "You\'92ve got to get up every morning with determination if you\'92re going to go to bed with satisfaction.", author: "George Lorimer", feeling: "unmotivated" \},\
                ...
                \{ text: "It\'92s not whether you get knocked down. It\'92s whether you get up.", author: "Vince Lombardi", feeling: "unmotivated" \}\
            ];\
